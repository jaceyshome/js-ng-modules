define [
  ...
  module = angular.module 'common.interactives.planning.workforce.decision', [
    'templates'
  ]
  module.directive 'planningWorkforceDecision', ($sce, Module, Structure, Scenario, $timeout)->
    restrict: "A"
    scope:
      settings: "="
    templateUrl: "common/interactives/planning/workforce/workforce"
